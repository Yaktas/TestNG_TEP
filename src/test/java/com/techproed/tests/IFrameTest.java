...
//        Verify the Bolded text contains “Editor”
        ...
        WebElement boldedText= Driver.getDriver().findElement(By.xpath("//h3"));
...
//        driver.switchTo().frame("mce_0_ifr");//We just need to put iframe ID value to switch to that iframe
        ...
        WebElement iframeElement=Driver.getDriver().findElement(By.xpath("//iframe[@id='mce_0_ifr']"));
        Driver.getDriver().switchTo().frame(iframeElement);


        Thread.sleep(3000);
        WebElement textBoxElement=Driver.getDriver().findElement(By.xpath("//p"));
...
//        Verify the text Elemental Selenium text is displayed on the page
        ...
        String elementText = Driver.getDriver().findElement(By.linkText("Elemental Selenium")).getText();
